...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelResult_2 = QLabel(self.gridLayoutWidget)
        self.labelResult_2.setObjectName(u"labelResult_2")
        self.labelResult_2.setFont(font1)

        self.gridLayout_2.addWidget(self.labelResult_2, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelResult_2.setText(QCoreApplication.translate("MainWindow", u"Seu nome:", None))
